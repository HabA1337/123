...
static io_status task5(const char* fa, const char* fb, const char* fc,
    ...
    std::vector<std::string>::iterator last = std::unique(words.begin(), words.end());
...
int main(int argc, char* argv[]) {
    ...
    clock_t start = clock();
    io_status status = task5(argv[1], argv[2], argv[3], sep, r);
    clock_t end = clock();
